...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "new_data_voltage_dpc_fast_h32_best"
...
#define AI_NETWORK_IN_2_HEIGHT      (1)
#define AI_NETWORK_IN_2_CHANNEL     (32)
#define AI_NETWORK_IN_2_SIZE        (32)
#define AI_NETWORK_IN_2_SIZE_BYTES  (128)
...
#define AI_NETWORK_OUT_2_CHANNEL     (32)
#define AI_NETWORK_OUT_2_SIZE        (32)
#define AI_NETWORK_OUT_2_SIZE_BYTES  (128)
