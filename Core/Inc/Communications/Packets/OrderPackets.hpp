...
public:
    ...
    static void Brake_init() { Brake_order = new HeapOrder(43, &Brake_cb); }
    static void Unbrake_init() { Unbrake_order = new HeapOrder(52, &Unbrake_cb); }
    ...
    static void Enable_Tapes_init() { Enable_Tapes_order = new HeapOrder(35, &Enable_Tapes_cb); }
    ...
    static void SVPWM_init(
        float& modulation_frequency,
        float& commutation_frequency,
        float& max_voltage,
        float& reference_voltage,
        motor_direction& motor_direction
    ) {
        SVPWM_order = new HeapOrder(
            57,
            &SVPWM_cb,
    ...
    static void Stop_Motor_init() { Stop_Motor_order = new HeapOrder(58, &Stop_Motor_cb); }
    static void Current_Control_init(
        float& modulation_frequency,
        float& commutation_frequency,
    ...
    static void Speed_Control_init(
        float& reference_speed,
        float& commutation_frequency,
        float& max_voltage,
        motor_direction& motor_direction
    ) {
        Speed_Control_order = new HeapOrder(
            60,
            &Speed_Control_cb,
            &reference_speed,
            &commutation_frequency,
    ...
    static void Motor_Brake_init() { Motor_Brake_order = new HeapOrder(61, &Motor_Brake_cb); }
    static void Recovery_init() { Recovery_order = new HeapOrder(32, &Recovery_cb); }

private:
    static void Brake_cb() { Brake_flag = true; }
    static void Unbrake_cb() { Unbrake_flag = true; }
    static void Potencia_Refri_cb() { Potencia_Refri_flag = true; }
    static void Set_Regulator_cb() { Set_Regulator_flag = true; }
    static void Enable_Tapes_cb() { Enable_Tapes_flag = true; }
    static void Disbable_Tapes_cb() { Disbable_Tapes_flag = true; }
    static void Close_Contactors_cb() { Close_Contactors_flag = true; }
    static void Open_Contactors_cb() { Open_Contactors_flag = true; }
    static void Levitation_cb() { Levitation_flag = true; }
    static void Stop_Levitation_cb() { Stop_Levitation_flag = true; }
    static void Emergency_Stop_cb() { Emergency_Stop_flag = true; }
    static void Propulsion_cb() { Propulsion_flag = true; }
    static void SVPWM_cb() { SVPWM_flag = true; }
    static void Stop_Motor_cb() { Stop_Motor_flag = true; }
    static void Current_Control_cb() { Current_Control_flag = true; }
    static void Speed_Control_cb() { Speed_Control_flag = true; }
    static void Motor_Brake_cb() { Motor_Brake_flag = true; }
    static void Recovery_cb() { Recovery_flag = true; }
};
